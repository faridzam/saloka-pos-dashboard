<div style="display: flex; width; 100%; justify-content: center;flex-wrap:wrap;">
    ...
    <h1 wire:poll>Rp. {{number_format($omset)}}</h1>
        ...
        <ul>
            ...
            <li class="media" style="display: flex; align-items: center; animation-duration: 0.5s">
                ...
                <div class="media-body" style="height: 100%">
                  <div class="float-right text-primary" style="float-right; font-size: 1.2rem;" wire:poll>Rp.&nbsp;{{number_format($value->total_revenue)}}</div>
